...
// Run from the repository root after building to output/shadow-week-build.
import http from 'node:http';
import fs from 'node:fs';
import path from 'node:path';
const root = path.resolve('output/shadow-week-build/browser');
...
}).listen(4367, '127.0.0.1', () => console.log('Restoration preview: http://127.0.0.1:4367/projects/shadow-gallery/experience?lesson=1'));
