export const balanceStageLayout = `<style>
 ...
 [data-balance-3d] .b3d-views{display:flex;padding:3px;border:1px solid #a6b9b933;border-radius:8px;gap:3px}
 [data-balance-3d] button{font:inherit;cursor:pointer}
 [data-balance-3d] .b3d-views button{border:0;border-radius:5px;color:#bfcacc;background:transparent;min-height:36px;padding:7px 13px;font-size:12px}
 [data-balance-3d] .b3d-views button[aria-pressed=true]{background:#344b4c;color:#fff2cd}
 [data-balance-3d] .b3d-viewport{position:relative;height:var(--balance-3d-height,clamp(410px,44vw,570px));min-height:360px;background:radial-gradient(ellipse at 45% 40%,#23363d,#0b151b 78%)}
 ...
 @media(max-width:600px){[data-balance-3d] .b3d-toolbar{padding:10px 12px;gap:7px}[data-balance-3d] .b3d-focus{font-size:9px;letter-spacing:1px}[data-balance-3d] .b3d-views button{font-size:11px;padding:7px 9px}[data-balance-3d] .b3d-viewport{height:400px}[data-balance-3d] .b3d-reading{left:14px;top:12px;font-size:10px}[data-balance-3d] .b3d-reading strong{font-size:14px}[data-balance-3d] .b3d-state{right:12px;bottom:12px;padding:8px;font-size:8px}[data-balance-3d] .b3d-tray{padding:14px 12px}[data-balance-3d] .b3d-weights{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}[data-balance-3d] .b3d-weight{min-height:76px}[data-balance-3d] .b3d-weight strong{font-size:21px}}
 </style>
 <div class="b3d-toolbar"><span class="b3d-focus" data-focus-label></span><div class="b3d-views" role="group" aria-label="3D camera view"><button data-view="working" aria-pressed="true">Scale &amp; pin</button><button data-view="overview" aria-pressed="false">All pins</button></div></div>
 <div class="b3d-viewport"><div class="b3d-reading"><strong data-equation></strong><span data-reading></span></div><div class="b3d-state" role="status" data-lock-state></div></div>
 <div class="b3d-tray"><div class="b3d-tray-title"><span>WEIGHT TRAY</span><small>Drag onto a pan, or select a weight below.</small></div><div class="b3d-weights" role="group" aria-label="3D workshop weight tray"></div><div class="b3d-placement" role="group" aria-label="Place selected weight" hidden><button data-place="1">Left pan</button><button data-place="2">Right pan</button><button data-place="0">Return to tray</button></div></div>`;
