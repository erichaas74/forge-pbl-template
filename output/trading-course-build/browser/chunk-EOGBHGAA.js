...
// src/app/projects/mystery-substance/mystery-substance.package.ts
var mysterySubstanceLocation = {
  tenantId: "local",
...
var mysteryVials = vialScans;
var mysteryEvidenceFiles = [
  {
...
var mysteryObservationTags = [
  "crystal edges",
  "sparkling grains",
  "fine particles",
  "uniform white color"
];
var scanEvidence = vialScans.map((vial) => ({
...
var fileEvidence = mysteryEvidenceFiles.map((evidence) => ({
  id: evidence.id,
  schemaVersion: "1.0",
...
var scanActivities = vialScans.map((vial) => ({
...
var scanRules = vialScans.map((vial) => ({
...
var mysterySubstanceProjectPackage = {
  "project.json": {
...
var mysteryInvestigationPhases = [
  {
    id: phaseIds[0],
    number: "01",
  ...
  },
  {
    ...
    shortTitle: "Bay 3",
    title: "Answer the Bay 3 call",
    instruction: "An unidentified white powder has to be identified before a crew can enter an acid spill. Spend the clock on the tests that can actually settle it.",
    activityIds: ["activity-emergency-response"]
  },
  {
    id: phaseIds[7],
...
var mysteryEvidenceCatalog = [
  ...mysteryEvidenceFiles.map((evidence) => __spreadProps(__spreadValues({}, evidence), {
    summary: evidence.text,
    source: "Recovered case file \xB7 Evidence Locker"
  })),
  ...vialScans.map((vial) => ({
    id: `evidence-scan-${vial.vialId}`,
    title: `Vial ${vial.code} optical scan`,
    ...
    summary: vial.cue,
    source: "Student optical scan \xB7 Shelf Incident Lab",
    asset: vial.image
  })),
  ...capabilityEvidence.map((evidence) => ({
    ...
    source: "Student activity result \xB7 Investigation workspace"
  }))
];
var mysteryInvestigationActivities = [
  ...vialScans.map((vial) => ({
    id: `activity-scan-${vial.vialId}`,
    title: `Optical scan \xB7 Vial ${vial.code}`,
...
var templateCapabilityGaps = [
  "formativeMasteryAndReteach",
  "secureTeacherMetadataProjection"
];
var migratedInvestigationCapabilities = [
...
var mysterySubstanceCatalogPackage = __spreadProps(__spreadValues({}, mysterySubstanceProjectPackage), {
  "project.json": __spreadProps(__spreadValues({}, mysterySubstanceProjectPackage["project.json"]), {
...
export {
  ...
  templateCapabilityGaps,
  migratedInvestigationCapabilities,
  mysterySubstanceCatalogPackage
};
//# debugId=848d4222-4f81-5b0d-bf80-19bbc8012fc9
//# sourceMappingURL=chunk-EOGBHGAA.js.map
