...
export const projectCatalog: readonly ProjectCatalogEntry[] = [
  {
    ...
    template: { id: 'time-repair', version: '1.0' },
    packageReference: 'projects/exploration-time-repair',
    capabilityIds: ['time-repair.timeline', 'time-repair.evidence-defense', 'time-repair.fixed-scene', 'time-repair.ripple'],
    title: 'Time Repair: Restore the Timeline',
    subtitle: 'Age of Exploration · The cargo that arrived too soon',
    grade: 'Grades 5–8',
    subject: 'Social Studies + ELA',
    projectType: 'Timeline Repair',
    description: 'Investigate a damaged timeline, connect historical evidence, earn a time jump, and repair a moment whose consequences ripple forward. One complete playable pilot mission.',
    learningGoals: ['Chronology and source analysis', 'Evidence-based claims', 'Cause, consequence, and uncertainty'],
    symbol: '⌁',
    theme: 'atlas',
    status: 'Pilot',
    studentInvitation: 'Investigate the breach',
    coverImage: '/projects/exploration-time-repair/harbor.png',
  },
  {
  ...
  },
  {
    ...
    description:
      'Explore a painted moonlit castle in a Phaser adventure. Choose grades 5-8 and solve nine physical math machines at eight rescue locations, open the pens, and lead twelve animated animals to the rescue boat.',
    learningGoals: [
      'Equivalent fractions, decimals and rational-number operations',
      'Coordinates, scale, geometric reflection and Pythagorean distance',
      'Common multiples, volume, ratios and proportional reasoning',
    ],
    symbol: '⌖',
    theme: 'archive',
    status: 'Preview',
