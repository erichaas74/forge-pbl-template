...
export const projectCatalog: readonly ProjectCatalogEntry[] = [
  ...
  },
  {
    ...
    subtitle: 'Ideas That Changed the World · Rescue an invention',
    grade: 'Grade 7',
    subject: 'Social Studies + ELA',
    projectType: 'Timeline Repair',
    description: 'Enter a world waiting for books, travel back to a failed workshop, diagnose the printing press, and help Gutenberg’s team change the next few years.',
    learningGoals: ['Invention and historical evidence', 'Mechanical diagnosis and controlled trials', 'Cause, consequence, and counterfactual history'],
    symbol: '⌁',
    theme: 'atlas',
    status: 'Pilot',
