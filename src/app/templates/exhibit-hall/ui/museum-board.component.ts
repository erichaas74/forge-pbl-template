...
import { MuseumRoomPresentationComponent } from '../rooms/museum-room-presentation.component';
import {
...
@Component({
  ...
  imports: [ObjectModelViewerComponent, MuseumRoomPresentationComponent],
