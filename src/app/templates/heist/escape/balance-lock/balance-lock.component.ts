...
@Component({
  ...
  styleUrl: './balance-lock.component.scss',
...
export class BalanceLockComponent implements AfterViewInit {
  ...
  readonly locked = computed(() => this.completed() || this.sealed().includes(this.active()));
