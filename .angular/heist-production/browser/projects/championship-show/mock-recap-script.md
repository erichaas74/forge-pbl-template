...
**New recap stills:** Use `art/week-1-budget-surprise-v1.png` during Nova's delivery-charge surprise and `art/week-2-graph-showdown-v1.png` during the graph investigation. Both have room on the left for live titles; a restrained push-in will match the studio opening.
